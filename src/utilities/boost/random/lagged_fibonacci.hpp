 ...
 */
        ...
        public:
            ...
            static result_type max BOOST_PREVENT_MACRO_SUBSTITUTION() { return low_bits_mask_t<w>::sig_bits; }
             ...
             */
            BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(lagged_fibonacci_engine, x_, y_) { return x_.i == y_.i &&
                                                                                            std::equal(x_.x,
                                                                                                       x_.x + long_lag,
                                                                                                       y_.x);
            }
 ...
 */
        ...
        public:
             ...
             * sequences of outputs.
             */
            BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(lagged_fibonacci_01_engine, x_, y_) { return x_.i == y_.i &&
                                                                                               std::equal(x_.x, x_.x +
                                                                                                                long_lag,
                                                                                                          y_.x);
            }
