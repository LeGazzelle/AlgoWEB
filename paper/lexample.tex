...
We also know that the aim of the CRT algorithm is to be sublinear in the number of edges (i.e. below $O(m)$, where m is the number of edges of the graph); we want now to show that it really happens, possibly for all the different types of graphs in our dataset.
 ...
 \begin{figure}[htbp]
  \centering
  \includegraphics[scale=0.5]{GAUSSIAN_E_02_W_20_D_10.png}
  \caption{Gaussian}
...
\begin{figure}[htbp]
  \centering 
  \includegraphics[scale=0.5]{SCALE_FREE_E_02_W_20_D_10.png}
  \caption{Scale-Free}
  ...
  \begin{figure}[htbp]
  \centering
   \includegraphics[scale=0.5]{SMALL_WORLD_E_02_W_20_D_10.png}
  \caption{Small-World}
  ...
  \begin{figure}[htbp]
  \centering
   \includegraphics[scale=0.5]{UNIFORM_E_02_W_20_D_10.png}
  \caption{Uniform}
...
Now we want to see what happens if there is an increase in the value of $d$, keeping other values unchanged.
  ...
  \begin{figure}[htbp]
  \centering
   \includegraphics[scale=0.5]{GAUSSIAN_E_02_W_20_D_100.png}
  \caption{Gaussian}
  ...
  \end{figure}
   ...
   \begin{figure}[htbp]
  \centering
   \includegraphics[scale=0.5]{SCALE_FREE_E_02_W_20_D_100.png}
  \caption{Scale-Free}
  \label{SCALE_FREE_E_02_W_20_D_100}
  \end{figure}
 
 
While in the corresponding Small-World graph and the corresponding Uniform graph the trend is similar to the Gaussian graph (Fig.~\ref{GAUSSIAN_E_02_W_20_D_100}), in the Scale-Free case the reader can easily see that CRT algorithm takes a little 'more time' to down permanently before Prim execution time (Fig.~\ref{SCALE_FREE_E_02_W_20_D_100}). This can be related to the presence, in this kind of graph, of different nodes that have an high degree, which can make slower the execution. \\ The reader can also may notice that for small instances (few edges) the CRT algorithm is worse than deterministic algorithms, but when increasing the graph size the trend returns to be sub-linear again. \\Also comparing, for example, (Fig.~\ref{GAUSSIAN_E_02_W_20_D_100}) with the corresponding (Fig.~\ref{GAUSSIAN_E_02_W_20_D_10}), one can easily see that the performances become worse, as expected having increased the $d$ value. \\ 

Let us now see what happens if we increase $w$, keeping $d$ and $\varepsilon$ unchanged.
 
\begin{figure}[htbp]
  \centering
   \includegraphics[scale=0.5]{GAUSSIAN_E_02_W_80_D_100.png}
  \caption{Gaussian}
  ...
  \begin{figure}[htbp]
  \centering
   \includegraphics[scale=0.5]{SMALL_WORLD_E_02_W_80_D_100.png}
  \caption{Small-World}
...
\end{itemize}
 ...
 \begin{figure}[htbp]
  ...
  \begin{figure}[htbp]
  \centering
   \includegraphics[scale=0.5]{SMALL_WORLD_E_04_W_20_D_10.png}
